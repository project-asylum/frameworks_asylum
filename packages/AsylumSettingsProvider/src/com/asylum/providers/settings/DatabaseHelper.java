...
/**
 * The SlimDatabaseHelper allows creation of a database to store Asylum specific settings for a user
 * in System, Secure, and Global tables.
 */
public class DatabaseHelper extends SQLiteOpenHelper{
    private static final String TAG = "AsylumDatabaseHelper";
    private static final boolean DEBUG = false;

    private static final String DATABASE_NAME = "asylum_settings.db";
        ...
        if (upgradeVersion < newVersion) {
            Log.w(TAG, "Got stuck trying to upgrade db. Old version: " + oldVersion
                    + ", version stuck at: " +  upgradeVersion + ", new version: "
                            + newVersion + ". Must wipe the asylum settings provider.");
