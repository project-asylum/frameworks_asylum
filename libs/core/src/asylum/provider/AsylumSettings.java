 ...
 */
public final class AsylumSettings {
    private static final String TAG = "AsylumSettings";
    private static final boolean LOCAL_LOGV = false;

    public static final String AUTHORITY = "asylumsettings";

    public static class AsylumSettingNotFoundException extends AndroidException {
        public AsylumSettingNotFoundException(String msg) {
            super(msg);
        }
    }
...
//            Log.d("TEST", "getStringForUser - " + name);
    ...
    public static final class System extends Settings.NameValueTable
            implements AsylumSettingsKeys.System {
        public static final String SYS_PROP_ASYLUM_SETTING_VERSION
                = "sys.asylumsetting_system_version";
        ...
        private static final NameValueCache sNameValueCache = new NameValueCache(
                SYS_PROP_ASYLUM_SETTING_VERSION,
                CONTENT_URI,
         ...
         * it throws {@link AsylumSettingNotFoundException}.
         *
         * @param cr The ContentResolver to access.
         * @param name The name of the setting to retrieve.
         *
         * @throws AsylumSettingNotFoundException Thrown if a setting by the given
         * name can't be found or the setting value is not an integer.
         *
         * @return The setting's current value.
         */
        public static int getInt(ContentResolver cr, String name)
                throws AsylumSettingNotFoundException {
        ...
        public static int getIntForUser(ContentResolver cr, String name, int userHandle)
            ...
            try {
                ...
                throw new AsylumSettingNotFoundException(name);
            }
        }
    ...
    public static final class Secure extends Settings.NameValueTable
            implements AsylumSettingsKeys.Secure {
        public static final String SYS_PROP_ASYLUM_SETTING_VERSION
                = "sys.asylumsetting_secure_version";
    ...
    public static final class Global extends Settings.NameValueTable
            implements AsylumSettingsKeys.Global {
        public static final String SYS_PROP_ASYLUM_SETTING_VERSION
                = "sys.asylumsetting_global_version";
