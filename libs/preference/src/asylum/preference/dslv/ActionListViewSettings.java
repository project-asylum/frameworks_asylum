...
package asylum.preference.dslv;
...
import com.asylum.action.ActionChecker;
import com.asylum.action.ActionConfig;
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            switch (id) {
                ...
                case DLG_SHOW_ICON_PICKER:
                    ...
                    .setNegativeButton(android.R.string.cancel, null)
                    .setItems(com.asylum.actions.R.array.icon_types,
                        new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            switch(which) {
                                case 0: // Default
        ...
        public class IconAdapter extends BaseAdapter {
            ...
            public IconAdapter(Context context) {
                labels = context.getResources().getStringArray(
                        com.asylum.actions.R.array.shortcut_icon_picker_labels);
                icons = context.getResources().obtainTypedArray(
                        com.asylum.actions.R.array.shortcut_icon_picker_icons);
